...
For displaying important messages that require user attention. Use `role="alert"` for dynamic content updates.

### Feed Pattern

https://www.w3.org/WAI/ARIA/apg/patterns/feed/examples/feed/

For infinite scroll and dynamic content loading. Provides keyboard navigation and screen reader announcements.
